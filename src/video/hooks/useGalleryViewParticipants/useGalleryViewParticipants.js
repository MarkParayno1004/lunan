...
export default function useGalleryViewParticipants(isMobileGalleryViewActive = false) {
    ...
    const [orderedParticipants, setOrderedParticipants] = useState(Array.from((_b = (_a = room === null || room === void 0 ? void 0 : room.participants) === null || _a === void 0 ? void 0 : _a.values()) !== null && _b !== void 0 ? _b : [], p => ({
        participant: p,
        ...
        if (dominantSpeaker !== null) {
            setOrderedParticipants(prevParticipants => {
                ...
                if (!firstPageParticipants.some(p => p.participant === dominantSpeaker)) {
                    ...
                    const sortedFirstPageParticipants = firstPageParticipants.sort((a, b) => a.dominantSpeakerStartTime - b.dominantSpeakerStartTime);
