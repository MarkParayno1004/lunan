...
const mockVideoContext = useVideoContext;
...
describe('the useGalleryViewParticipants hook', () => {
    ...
    it('should handle "participantConnected" events', () => __awaiter(void 0, void 0, void 0, function* () {
        const { result } = renderHook(() => useGalleryViewParticipants());
        act(() => {
    ...
    it('should handle "participantDisconnected" events', () => __awaiter(void 0, void 0, void 0, function* () {
        const { result } = renderHook(() => useGalleryViewParticipants());
        act(() => {
