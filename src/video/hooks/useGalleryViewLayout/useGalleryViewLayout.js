 ...
 */
export const layoutIsTooSmall = (newVideoSize, participantCount, containerWidth, containerHeight) => {
 ...
 */
export default function useGalleryViewLayout(participantCount) {
    ...
    const updateLayout = useCallback(() => {
        ...
        let minVideoWidth = 0;
        let maxVideoWidth = Math.pow(2, 14);
