...
const customHistory = Object.assign(Object.assign({}, createBrowserHistory()), {
  replace: jest.fn(),
});
const wrapper = (props) =>
  React.createElement(Router, { history: customHistory }, props.children);
describe("the usePasscodeAuth hook", () => {
  describe("on first render", () => {
    beforeEach(() => window.sessionStorage.clear());
    it("should return a user when the passcode is valid", () =>
    ...
    it("should remove the query parameter from the URL when the passcode is valid", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        // @ts-ignore
        window.fetch = jest.fn(() =>
          Promise.resolve({
    ...
    it("should not return a user when the app code is invalid", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        // @ts-ignore
        window.fetch = jest.fn(() =>
          Promise.resolve({
  ...
  describe("signout function", () => {
    it("should clear session storage and user on signout", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        // @ts-ignore
        window.fetch = jest.fn(() =>
          Promise.resolve({
  ...
  describe("signin function", () => {
    it("should set a user when a valid passcode is submitted", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        // @ts-ignore
        window.fetch = jest.fn(() =>
          Promise.resolve({
    ...
    it("should return an error when an invalid passcode is submitted", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        // @ts-ignore
        window.fetch = jest.fn(() =>
          Promise.resolve({
    ...
    it("should return an error when an expired passcode is submitted", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        // @ts-ignore
        window.fetch = jest.fn(() =>
          Promise.resolve({
  ...
  describe("the getToken function", () => {
    ...
    it("should call the API with the correct parameters when REACT_APP_DISABLE_TWILIO_CONVERSATIONS is true", () =>
      __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("should return a useful error message from the serverless function", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        // @ts-ignore
        window.fetch = jest.fn(() =>
...
describe("the verifyPasscode function", () => {
  it("should return the correct response when the passcode is valid", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      // @ts-ignore
      window.fetch = jest.fn(() =>
        Promise.resolve({
  ...
  it("should return the correct response when the passcode is invalid", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      // @ts-ignore
      window.fetch = jest.fn(() =>
        Promise.resolve({
