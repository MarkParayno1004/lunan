...
const customHistory = Object.assign(Object.assign({}, createBrowserHistory()), { replace: jest.fn() });
const wrapper = (props) => (React.createElement(Router, { history: customHistory }, props.children));
describe('the usePasscodeAuth hook', () => {
    describe('on first render', () => {
        beforeEach(() => window.sessionStorage.clear());
        it('should return a user when the passcode is valid', () => __awaiter(void 0, void 0, void 0, function* () {
            // @ts-ignore
            window.fetch = jest.fn(() => Promise.resolve({ ok: true, json: () => Promise.resolve({ token: 'mockVideoToken' }) }));
        ...
        it('should remove the query parameter from the URL when the passcode is valid', () => __awaiter(void 0, void 0, void 0, function* () {
            // @ts-ignore
            window.fetch = jest.fn(() => Promise.resolve({ ok: true, json: () => Promise.resolve({ token: 'mockVideoToken' }) }));
            // @ts-ignore
            window.location = {
        ...
        it('should not return a user when the app code is invalid', () => __awaiter(void 0, void 0, void 0, function* () {
            // @ts-ignore
            window.fetch = jest.fn(() => Promise.resolve({ status: 401, json: () => Promise.resolve({ type: 'errorMessage' }) }));
    ...
    describe('signout function', () => {
        it('should clear session storage and user on signout', () => __awaiter(void 0, void 0, void 0, function* () {
            // @ts-ignore
            window.fetch = jest.fn(() => Promise.resolve({ ok: true, json: () => Promise.resolve({ token: 'mockVideoToken' }) }));
            window.sessionStorage.setItem('passcode', '123123');
            const { result, waitForNextUpdate } = renderHook(usePasscodeAuth, { wrapper });
            yield waitForNextUpdate();
            yield act(() => result.current.signOut());
            expect(window.sessionStorage.getItem('passcode')).toBe(null);
            expect(result.current.user).toBe(null);
        }));
    });
    describe('signin function', () => {
        it('should set a user when a valid passcode is submitted', () => __awaiter(void 0, void 0, void 0, function* () {
            // @ts-ignore
            window.fetch = jest.fn(() => Promise.resolve({ ok: true, json: () => Promise.resolve({ token: 'mockVideoToken' }) }));
            const { result } = renderHook(usePasscodeAuth, { wrapper });
            yield act(() => result.current.signIn('123456'));
            expect(result.current.user).toEqual({ passcode: '123456' });
        }));
        it('should return an error when an invalid passcode is submitted', () => __awaiter(void 0, void 0, void 0, function* () {
            // @ts-ignore
            window.fetch = jest.fn(() => Promise.resolve({ status: 401, json: () => Promise.resolve({ error: { message: 'passcode incorrect' } }) }));
            const { result, waitForNextUpdate } = renderHook(usePasscodeAuth, { wrapper });
            yield waitForNextUpdate();
        ...
        it('should return an error when an expired passcode is submitted', () => __awaiter(void 0, void 0, void 0, function* () {
            // @ts-ignore
            window.fetch = jest.fn(() => Promise.resolve({ status: 401, json: () => Promise.resolve({ error: { message: 'passcode expired' } }) }));
            const { result, waitForNextUpdate } = renderHook(usePasscodeAuth, { wrapper });
            yield waitForNextUpdate();
            result.current.signIn('123456').catch(err => {
    ...
    describe('the getToken function', () => {
        it('should call the API with the correct parameters', () => __awaiter(void 0, void 0, void 0, function* () {
            // @ts-ignore
            window.fetch = jest.fn(() => Promise.resolve({ ok: true, json: () => Promise.resolve({ token: 'mockVideoToken' }) }));
            window.sessionStorage.setItem('passcode', '123123');
            const { result, waitForNextUpdate } = renderHook(usePasscodeAuth, { wrapper });
        ...
        it('should call the API with the correct parameters when REACT_APP_DISABLE_TWILIO_CONVERSATIONS is true', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should return a token', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            let token = '';
            yield act(() => __awaiter(void 0, void 0, void 0, function* () {
                token = yield result.current.getToken('test-name', 'test-room');
            }));
            expect(token).toEqual({ token: 'mockVideoToken' });
        }));
        it('should return a useful error message from the serverless function', () => __awaiter(void 0, void 0, void 0, function* () {
            // @ts-ignore
...
describe('the verifyPasscode function', () => {
    it('should return the correct response when the passcode is valid', () => __awaiter(void 0, void 0, void 0, function* () {
        // @ts-ignore
        window.fetch = jest.fn(() => Promise.resolve({ ok: true, json: () => Promise.resolve({ token: 'mockVideoToken' }) }));
        const result = yield verifyPasscode('123456');
        expect(result).toEqual({ isValid: true });
    }));
    it('should return the correct response when the passcode is invalid', () => __awaiter(void 0, void 0, void 0, function* () {
        // @ts-ignore
        window.fetch = jest.fn(() => Promise.resolve({ status: 401, json: () => Promise.resolve({ error: { message: 'errorMessage' } }) }));
        const result = yield verifyPasscode('123456');
        expect(result).toEqual({ isValid: false, error: 'errorMessage' });
    }));
    it('should call the API with the correct parameters', () => __awaiter(void 0, void 0, void 0, function* () {
        yield verifyPasscode('123456');
        expect(window.fetch).toHaveBeenLastCalledWith('/token', {
