...
const mockUsePasscodeAuth = usePasscodeAuth;
// @ts-ignore
...
const wrapper = ({ children }) => React.createElement(AppStateProvider, null, children);
describe('the useAppState hook', () => {
    ...
    it('should get a token using the REACT_APP_TOKEN_ENDPOINT environment variable when avaiable', () => __awaiter(void 0, void 0, void 0, function* () {
        process.env.REACT_APP_TOKEN_ENDPOINT = 'http://test.com/api/token';
        const { result } = renderHook(useAppState, { wrapper });
        let token;
        yield act(() => __awaiter(void 0, void 0, void 0, function* () {
            token = yield result.current.getToken('testname', 'testroom');
        }));
    ...
    describe('with auth disabled', () => {
        it('should not use any auth hooks', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('with firebase auth enabled', () => {
        it('should use the useFirebaseAuth hook', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('with passcode auth enabled', () => {
        it('should use the usePasscodeAuth hook', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('the getToken function', () => {
        it('should set isFetching to true after getToken is called, and false after getToken succeeds', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should set isFetching to true after getToken is called, and false after getToken fails', () => __awaiter(void 0, void 0, void 0, function* () {
            process.env.REACT_APP_SET_AUTH = 'passcode';
            mockUsePasscodeAuth.mockImplementation(() => {
                return {
                    getToken: () => new Promise((_, reject) => {
