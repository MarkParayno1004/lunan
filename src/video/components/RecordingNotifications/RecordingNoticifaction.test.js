...
describe('the RecordingNotification component', () => {
    ...
    it('should not display a notification when recording is not in progress', () => {
        const wrapper = mount(React.createElement(RecordingNotifications, null));
        expect(wrapper
            .find(Snackbar)
            .find({ open: true })
            .exists()).toBe(false);
    ...
    it('should display "Recording In Progress" Snackbar when a user joins a room and recording is in progress', () => {
        ...
        expect(wrapper
            ...
            .find({ open: true })
            .first()
            .prop('headline')).toMatchInlineSnapshot(`"Recording is in progress."`);
    });
    it('should display "Recording Started" Snackbar when a recording is started after a user joins a room', () => {
        ...
        expect(wrapper
            ...
            .find({ open: true })
            .first()
            .prop('headline')).toMatchInlineSnapshot(`"Recording has started."`);
    });
    it('should display "Recording Complete" Snackbar when a recording stops ', () => {
        ...
        expect(wrapper
            ...
            .find({ open: true })
            .first()
            .prop('headline')).toMatchInlineSnapshot(`"Recording Complete"`);
    });
});
