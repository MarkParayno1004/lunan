...
import ToggleScreenShareButton, { SCREEN_SHARE_TEXT, SHARE_IN_PROGRESS_TEXT, SHARE_NOT_SUPPORTED_TEXT, } from './ToggleScreenShareButton';
...
describe('the ToggleScreenShareButton component', () => {
    it('should render correctly when screenSharing is allowed', () => {
        const wrapper = mount(React.createElement(ToggleScreenShareButton, null));
    ...
    it('should call the correct toggle function when clicked', () => {
        const wrapper = shallow(React.createElement(ToggleScreenShareButton, null));
