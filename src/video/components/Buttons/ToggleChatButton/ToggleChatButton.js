...
export default function ToggleChatButton() {
    ...
    return (React.createElement(Button, { "data-cy-chat-button": true, onClick: toggleChatWindow, disabled: !conversation, startIcon: React.createElement("div", { className: classes.iconContainer },
            React.createElement(ChatIcon, null),
            React.createElement("div", { className: clsx(classes.ring, { [classes.animateRing]: shouldAnimate }) }),
            React.createElement("div", { className: clsx(classes.circle, { [classes.hasUnreadMessages]: hasUnreadMessages }) })) }, "Chat"));
}
