...
export default function ChatWindow() {
    ...
    return (React.createElement("aside", { className: clsx(classes.chatWindowContainer, { [classes.hide]: !isChatWindowOpen }) },
        React.createElement(ChatWindowHeader, null),
        React.createElement(MessageList, { messages: messages }),
        React.createElement(ChatInput, { conversation: conversation, isChatWindowOpen: isChatWindowOpen })));
}
