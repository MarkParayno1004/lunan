...
export class MessageListScrollContainer extends React.Component {
    constructor() {
        ...
        this.state = { isScrolledToBottom: true, showButton: false, messageNotificationCount: 0 };
        this.handleScroll = throttle(() => {
            ...
            const isScrolledToBottom = Math.abs(innerScrollContainerEl.clientHeight + innerScrollContainerEl.scrollTop - innerScrollContainerEl.scrollHeight) < 1;
    ...
    render() {
        ...
        return (React.createElement("div", { className: classes.outerContainer },
            React.createElement("div", { className: classes.innerScrollContainer, ref: this.chatThreadRef, "data-cy-message-list-inner-scroll": true },
                React.createElement("div", { className: classes.messageListContainer },
                    this.props.children,
                    React.createElement(Button, { className: clsx(classes.button, { [classes.showButton]: this.state.showButton }), onClick: this.handleClick, startIcon: React.createElement(ArrowDownwardIcon, null), color: "primary", variant: "contained", "data-cy-new-message-button": true },
                        this.state.messageNotificationCount,
                        " new message",
