...
describe('the ParticipantInfo component', () => {
    it('should render the AvatarIcon component when no video tracks are published', () => {
        ...
        const wrapper = shallow(React.createElement(ParticipantInfo, { onClick: () => { }, isSelected: false, participant: { identity: 'mockIdentity' } }, "mock children"));
    ...
    it('should add hideParticipant class to container component when hideParticipant prop is true', () => {
        const wrapper = shallow(React.createElement(ParticipantInfo, { onClick: () => { }, isSelected: false, participant: { identity: 'mockIdentity' }, hideParticipant: true }, "mock children"));
    ...
    it('should not add hideParticipant class to container component when hideParticipant prop is false', () => {
        const wrapper = shallow(React.createElement(ParticipantInfo, { onClick: () => { }, isSelected: false, participant: { identity: 'mockIdentity' }, hideParticipant: false }, "mock children"));
    ...
    it('should add cursorPointer class to container component when onClick prop is present', () => {
        const wrapper = shallow(React.createElement(ParticipantInfo, { isSelected: false, participant: { identity: 'mockIdentity' }, onClick: () => { } }, "mock children"));
    ...
    it('should not add cursorPointer class to container component when onClick prop is not present', () => {
        const wrapper = shallow(React.createElement(ParticipantInfo, { isSelected: false, participant: { identity: 'mockIdentity' } }, "mock children"));
    ...
    it('should render the PinIcon component when the participant is selected', () => {
        mockUsePublications.mockImplementation(() => [{ trackName: '', kind: 'video' }]);
        const wrapper = shallow(React.createElement(ParticipantInfo, { onClick: () => { }, isSelected: true, participant: { identity: 'mockIdentity' } }, "mock children"));
    ...
    it('should add "(You)" to the participants identity when they are the localParticipant', () => {
        ...
        mockUsePublications.mockImplementation(() => [{ trackName: '', kind: 'video' }]);
        const wrapper = shallow(React.createElement(ParticipantInfo, { onClick: () => { }, isSelected: false, participant: { identity: 'mockIdentity' }, isLocalParticipant: true }, "mock children"));
