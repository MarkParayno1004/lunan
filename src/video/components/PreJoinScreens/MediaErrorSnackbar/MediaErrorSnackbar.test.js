...
describe('the MediaErrorSnackBar', () => {
    ...
    it('should be closed by default', () => {
        const wrapper = shallow(React.createElement(MediaErrorSnackBar, null));
        expect(wrapper.prop('open')).toBe(false);
    });
    it('should open when there is an error', () => {
        const wrapper = shallow(React.createElement(MediaErrorSnackBar, { error: new Error('testError') }));
