...
export function getSnackbarContent(hasAudio, hasVideo, error) {
    ...
    switch (true) {
        ...
        case (error === null || error === void 0 ? void 0 : error.message) === 'CameraPermissionsDenied':
            ...
            break;
        case (error === null || error === void 0 ? void 0 : error.message) === 'MicrophonePermissionsDenied':
            headline = 'Unable to Access Media:';
            message =
...
export default function MediaErrorSnackbar({ error }) {
    ...
    const isSnackbarOpen = !isSnackbarDismissed &&
    ...
    return (React.createElement(Snackbar, { open: isSnackbarOpen, handleClose: () => setIsSnackbarDismissed(true), headline: headline, message: message, variant: "warning" }));
}
