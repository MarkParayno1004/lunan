...
describe('the DeviceSelectionScreen component', () => {
    ...
    describe('when connecting to a room', () => {
        ...
        const wrapper = shallow(React.createElement(DeviceSelectionScreen, { name: "test name", roomName: "test room name", setStep: () => { } }));
    ...
    it('should go back to the RoomNameScreen when the Cancel button is clicked', () => {
        ...
        const wrapper = shallow(React.createElement(DeviceSelectionScreen, { name: "test name", roomName: "test room name", setStep: mockSetStep }));
