...
const mockUseFlipCameraToggle = useFlipCameraToggle;
    ...
    describe('the recording button', () => {
        describe('while recording is in progress', () => {
            ...
            it('should display "Stop Recording"', () => {
                const { getByText } = render(React.createElement(Menu, null));
        ...
        describe('while recording is not in progress', () => {
            ...
            it('should not render the recording button in go rooms', () => {
                ...
                const { getByText, queryByText } = render(React.createElement(Menu, null));
                fireEvent.click(getByText('More'));
            ...
            it('should disable the Start Recording button when isFetching is true', () => __awaiter(void 0, void 0, void 0, function* () {
                mockUseAppState.mockImplementationOnce(() => ({ isFetching: true }));
                const wrapper = shallow(React.createElement(Menu, null));
                expect(wrapper
                    .find(MenuItem)
                    .at(1)
