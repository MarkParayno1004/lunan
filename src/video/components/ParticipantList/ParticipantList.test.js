...
const mockParticipantContext = useParticipantContext;
const mockedVideoContext = useVideoContext;
const mockUseSelectedParticipant = useSelectedParticipant;
const mockUseMainParticipant = useMainParticipant;
...
describe('the ParticipantList component', () => {
    ...
    it('should correctly render Participant components', () => {
        ...
        const wrapper = shallow(React.createElement(ParticipantList, null));
    ...
    it('should add the hideParticipant prop when the participant is the mainParticipant', () => {
        ...
        expect(wrapper
            .find('Memo(Participant)')
            .at(1)
            .prop('hideParticipant')).toBe(true);
        expect(wrapper
            .find('Memo(Participant)')
            .at(2)
            .prop('hideParticipant')).toBe(false);
    });
