...
import SupervisorSubmittedDailyForms from "./supervisor_submitted_daily_form_component";
import SupervisorVerifiedDailyForms from "./supervisor_verified_daily_form_component";

export default function SupervisorViewDailyForms(props) {
    ...
    function getTabContent(activeTab) {
        if (activeTab === "Submitted") {
          return <SupervisorSubmittedDailyForms wellForms={wellForms} />;
        } else if (activeTab === "Verified") {
          return <SupervisorVerifiedDailyForms wellForms={wellForms} />;
        }
    }
