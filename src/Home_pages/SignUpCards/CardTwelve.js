...
export const CardTwelve = ({ ButtonBack, ButtonSubmit, formData }) => {
        ...
        <div class="container-fluid d-flex justify-content-center">
          <div class="card" style={{ width: 60 + "rem" }}>
            <div class="card-header">
              ...
              relatives) experienced difficulties with the following? (circle
              any that apply and list family member, e.g., Sibling, Parent,
              Uncle, etc.):
            </div>
