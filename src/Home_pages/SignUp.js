...
import PP from "../img/PrivacyPolicy.png";
...
const PrivacyPolicy = () => {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Bloomfields Wellness Institute, #98 SAN
            PEDRO BAUTISTA ST. BRGY. DAMAYAN 1104.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Bloomfields-Lunan, accessible
            from{" "}
            <a
              href="https://bloomfields-lunan.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://bloomfields-lunan.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: bloomfieldspartnership@gmail.com</p>
        </li>
        <li>
          <p>By phone number: 0920 528 7823</p>
        </li>
      </ul>
    </>
  );
