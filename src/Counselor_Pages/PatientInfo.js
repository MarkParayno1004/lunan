    ...
    return (
        <div className="container-fluid d-flex justify-content-center" id="plBG">
            <div className="container-lg mt-3 mb-3 rounded-4 fw-normal d-flex justify-content-center" id="CardBG">
                <h1 className="d-flex justify-content-center mt-3">Patients Information</h1>
                <div className="patient-info">
                    <div className="patient-details">
                        <img src={patient.picture} alt={patient.name} className="patient-picture" />
