            ...
            <div className="container text-center">
                <div className="row align-items-start">
                    ...
                    <div className="col d-flex justify-content-end">
                        <Link to="/View Patients" style={{ textDecoration: "none" }}>
                            <div>
                                <div
                    ...
                    <div className="col d-flex justify-content-end">
                        <Link to="/Patients Weekly Forms" style={{ textDecoration: "none" }}>
                            <div>
                                <div
                                    className="card rounded-5"
                                    style={{ width: 18 + "rem" }}
                    ...
                    <div className="col d-flex justify-content-end">
                        <Link to="/Patients Wellness Forms" style={{ textDecoration: "none" }}>
                            <div>
                                <div
                                    className="card rounded-5"
                                    style={{ width: 18 + "rem" }}
