...
import CounselorPatientListComponent from "../Components/counselor_patient_list_component";
...
function CounselorDashboardPage() {
  ...
  return (
    <div>
      <aside
        id="default-sidebar"
        className="fixed top-0 left-0 z-40 w-72 h-screen transition-transform -translate-x-full sm:translate-x-0 text-white"
        aria-label="Sidebar"
      >
        ...
        <div>
          {(() => {
            if (activeComponent === "DashboardComponent") {
              ...
              return <CounselorPatientListComponent />;
